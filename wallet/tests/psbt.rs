...
use bdk_wallet::{psbt, KeychainKind};
use bitcoin::key::Secp256k1;
use core::str::FromStr;

// from bip 174
// "PSBT with one P2PKH input and one P2SH-P2WPKH input. First input is signed and finalized.
// Outputs are empty".
...
// This looks like the same test as above
#[test]
#[ignore = "duplicate"]
#[should_panic(expected = "IndexOutOfBounds")]
...
#[test]
#[should_panic(expected = "IndexOutOfBoundsError")]
fn test_psbt_malformed_tx_input() {
    ...
    let _ = wallet.finalize_psbt(&mut psbt).unwrap();
}
